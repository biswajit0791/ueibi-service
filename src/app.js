...
import bloodGroupRoutes from './routes/bloodGroup.routes.js';
import goalOptionRoutes from './routes/goalOption.routes.js';
import subLoginRoutes from './routes/subLogin.routes.js';
...
apiRouter.use(bloodGroupRoutes);
apiRouter.use(goalOptionRoutes);
apiRouter.use(subLoginRoutes);
